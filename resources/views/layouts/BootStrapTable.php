...
<!-- Create New Book Modal HTML (BootStrap Model for Create a new  Book) -->
...
<!-- Edit Book Modal HTML (BootStrap Model for EDIT Books Details) -->

<div id="editBookModal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
...
<!-- Delete BOOK Modal HTML (BootStrap Model for DELETE Book) -->

<div id="deleteBookModal" class="modal fade" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
